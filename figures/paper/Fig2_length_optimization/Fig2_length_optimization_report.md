...
- Metrics table: `figures/paper/Fig3_length_optimization/Fig3_length_optimization_data.csv`
- Fiber loss loader: `fiber_loss/*.xlsx (Input/Output columns → transmission_loss_db)`

### Fiber loss inputs read

- `fiber_loss/Fiber13cm.xlsx`
- `fiber_loss/fiber11cm.xlsx`
- `fiber_loss/fiber16cm.xlsx`
- `fiber_loss/fiber8cm.xlsx`
- `fiber_loss/fiber9cm.xlsx`
...
- Optimal JSON: `results/length_optimization_green/optimal_length.json`
- Config: `config/length_optimization_green.yaml`
